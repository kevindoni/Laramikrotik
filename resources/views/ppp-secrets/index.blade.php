        ...
        <div>
            ...
            <form action="{{ route('ppp-secrets.sync-from-mikrotik') }}" method="POST" class="d-inline">
                ...
                <button type="submit" class="btn btn-sm btn-info shadow-sm"
                        onclick="return confirm('Sync secrets from MikroTik?')">
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <form action="{{ route('ppp-secrets.sync-to-mikrotik', $secret) }}" 
                                                ...
                                                @csrf
                                                <button type="submit" class="dropdown-item" 
                                                        onclick="return confirm('Push this secret to MikroTik?')">
...
$(document).ready(function() {
    ...
    $('#secretsTable').DataTable({
        ...
        "language": {
            ...
            "lengthMenu": "Show _MENU_ secrets per page",
            "info": "Showing _START_ to _END_ of _TOTAL_ secrets",
            "infoEmpty": "No secrets found",
            "infoFiltered": "(filtered from _MAX_ total secrets)",
            "zeroRecords": "No matching secrets found",
            "paginate": {
                "first": "First",
                "last": "Last", 
                "next": "Next",
