                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control @error('identity_card') is-invalid @enderror" 
                                    ...
                                    <option value="KTP" {{ old('identity_card', $customer->identity_card) == 'KTP' ? 'selected' : '' }}>KTP</option>
                                    <option value="SIM" {{ old('identity_card', $customer->identity_card) == 'SIM' ? 'selected' : '' }}>SIM</option>
                                    <option value="Passport" {{ old('identity_card', $customer->identity_card) == 'Passport' ? 'selected' : '' }}>Passport</option>
                                </select>
                                @error('identity_card')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
